...
v1 campaign (spec + ailoop drive, E1–E9) is complete and archived at `specs/v1/` — a record, not a source. New feature work gets a fresh spec via `/aispec`; don't amend the archive.
